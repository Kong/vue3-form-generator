(function(global2, factory) {
  ...
  function render$k(_ctx, _cache, $props, $setup, $data, $options) {
    const _directive_attributes = vue.resolveDirective("attributes");
    return vue.withDirectives((vue.openBlock(), vue.createElementBlock("div", _hoisted_1$m, [
      _ctx.schema.listBox ? (vue.openBlock(), vue.createElementBlock("div", {
        key: 0,
        ...
        (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList($options.items, (item) => {
          return vue.openBlock(), vue.createElementBlock("div", {
            class: vue.normalizeClass(["list-row", { "is-checked": $options.isItemChecked(item) }])
          }, [
      ...
      !_ctx.schema.listBox ? (vue.openBlock(), vue.createElementBlock("div", {
        ...
        vue.createElementVNode("div", {
          class: vue.normalizeClass(["mainRow", { expanded: $data.comboExpanded }]),
        ...
        vue.createElementVNode("div", _hoisted_7$1, [
          $data.comboExpanded ? (vue.openBlock(true), vue.createElementBlock(vue.Fragment, { key: 0 }, vue.renderList($options.items, (item) => {
            return vue.openBlock(), vue.createElementBlock("div", {
              class: vue.normalizeClass(["list-row", { "is-checked": $options.isItemChecked(item) }])
            }, [
              vue.createElementVNode("label", null, [
  ...
  function render$j(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    return vue.withDirectives((vue.openBlock(), vue.createElementBlock("div", _hoisted_1$l, [
      vue.withDirectives(vue.createElementVNode("input", {
        class: vue.normalizeClass(["form-control", _ctx.schema.fieldClasses]),
        id: _ctx.getFieldID(_ctx.schema),
  ...
  function render$h(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    return vue.withDirectives((vue.openBlock(), vue.createElementBlock("div", {
      ...
      (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList($options.items, (item) => {
        return vue.withDirectives((vue.openBlock(), vue.createElementBlock("label", {
          class: vue.normalizeClass($options.getItemCssClasses(item))
        }, [
          vue.withDirectives(vue.createElementVNode("input", {
            id: _ctx.getFieldID(_ctx.schema, true),
            type: "radio",
  ...
  function render$g(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    return vue.withDirectives((vue.openBlock(), vue.createElementBlock("select", {
      ...
      !$options.selectOptions.hideNoneSelectedText ? (vue.openBlock(), vue.createElementBlock("option", {
        ...
        value: null
      }, vue.toDisplayString($options.selectOptions.noneSelectedText || "<Nothing selected>"), 9, _hoisted_2$8)) : vue.createCommentVNode("", true),
      (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList($options.items, (item) => {
  ...
  function render$9(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("div", _hoisted_1$b, [
      vue.withDirectives(vue.createElementVNode("input", {
        ...
        [vue.vShow, _ctx.schema.hideInput !== true],
        [vue.vModelText, $options.wrappedValue]
      ]),
      _ctx.schema.browse !== false ? (vue.openBlock(), vue.createElementBlock("input", {
        key: 0,
  ...
  function _sfc_render$1(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("div", {
      class: vue.normalizeClass(["slider", { "contain-pips": $options.containPips, "contain-tooltip": $options.containTooltip }]),
      disabled: _ctx.disabled || null
  ...
  function render$5(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.withDirectives((vue.openBlock(), vue.createElementBlock("select", {
      ...
      _ctx.schema.multiSelect !== true ? (vue.openBlock(), vue.createElementBlock("option", {
        key: 0,
        disabled: _ctx.schema.required || null,
        value: null,
  ...
  function render$3(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("img", { src: $options.mapLink }, null, 8, _hoisted_1$4);
  }
  ...
  function render$1(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    return vue.openBlock(), vue.createBlock(_component_multiselect, {
      ...
      default: vue.withCtx(() => [
        vue.createElementVNode("span", _hoisted_1$2, vue.toDisplayString($options.selectOptions.noResult), 1),
        vue.createElementVNode("span", _hoisted_2$2, vue.toDisplayString($options.selectOptions.maxElements), 1)
      ]),
      _: 1
  ...
  function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("div", {
      ...
      $options.fieldTypeHasLabel($props.field) ? (vue.openBlock(), vue.createElementBlock("label", {
        key: 0,
        for: $options.getFieldID($props.field),
        class: vue.normalizeClass($props.field.labelClasses)
      }, [
        vue.createElementVNode("span", {
        ...
        $options.buttonVisibility($props.field) ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_7, [
          (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList($props.field.buttons, (btn, index) => {
            return vue.openBlock(), vue.createElementBlock("button", {
              ...
              class: vue.normalizeClass(btn.classes),
              key: index,
      ...
      $props.field.hint ? (vue.openBlock(), vue.createElementBlock("div", {
        key: 1,
        class: "hint",
  ...
  function render(_ctx, _cache, $props, $setup, $data, $options) {
    const _component_form_group = vue.resolveComponent("form-group");
    return $props.schema != null ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_1, [
      $props.schema.fields ? (vue.openBlock(), vue.createElementBlock("fieldset", {
        ...
        (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList($options.fields, (field) => {
          return vue.openBlock(), vue.createElementBlock(vue.Fragment, null, [
            $options.fieldVisible(field) ? (vue.openBlock(), vue.createBlock(_component_form_group, {
              ...
              onValidated: $options.onFieldValidated,
              onModelUpdated: $options.onModelUpdated
            }, null, 8, ["vfg", "field", "errors", "model", "options", "onValidated", "onModelUpdated"])) : vue.createCommentVNode("", true)
          ], 64);
        }), 256))
